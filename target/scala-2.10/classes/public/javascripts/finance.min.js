...
sortList:[[1,0]]})};var updateTableSort=function(resort){var table=$("#transaction-table");table.trigger("update",[resort])};$("#transaction-table").on("click","#delete",deleteTransCallback);$("#transaction-table").on("click","#updateButton",updateTransCallback);$("#transaction-table").on("click","#add",addTransCallback);$("#transaction-table").on("click",".save",saveRow);$("#transaction-table").on("click",".cancel",removeFormView);$("#folder-list").on("click",".cancel",removeFormView);$("#addFolder").on("click",
addFolder);$("#deleteFolder").on("click",deleteFolder);$("#updateFolder").on("click",updateFolder);$("#folder-list").on("click",".folder",selectFolder);$("#folder-list").on("click","#saveFolder",saveFolder);listFolders()});