...
alter table finance_folder add constraint fk_finance_folder_user_1 foreign key (user_email) references account (email) on delete restrict on update restrict;
